...
const SCHOOL = "MyCollege";
//SCHOOL = "MySecondCollege";
// It is an error because we used 'const', which is cannot be reassigned, it is constant.
...
console.log(2 + "3");
console.log(2 + 3);
// because when there are at least one string, javascript consider them as string, but if both numbers it does arithmetic operations.
...
console.log(a);
//console.log(b);
// when I tried to print 'b' it gave me error in the console, because it declared using let.
